...
function showGuide(force=false){if(force||!localStorage.getItem('liberacao-guide-v4')){$('guide').classList.add('open')}}
$('helpBtn').onclick=()=>showGuide(true);
$('closeGuide').onclick=()=>{$('guide').classList.remove('open');localStorage.setItem('liberacao-guide-v4','1')};
